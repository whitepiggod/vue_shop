<template>
  <div>
    ...
    <el-card>
      ...
      <tree-table :data="catelist" :columns="columns" :selection-type="false" :expand-type="false" show-index index-text="#" border class="treeTable">
        ...
        <template slot="opt" slot-scope="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="editCategories(scope.row.cat_id)">编辑</el-button>
    ...
    <el-dialog
      ...
      <!-- 添加分类的表单 -->
      <el-form :model="editCateForm" :rules="editCateFormRoles" ref="editCateFormRef" label-width="100px">
        <el-form-item label="分类名称:" prop="cat_name">
